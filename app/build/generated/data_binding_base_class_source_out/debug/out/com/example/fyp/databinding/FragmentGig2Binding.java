...
public final class FragmentGig2Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentGig2Binding(@NonNull ConstraintLayout rootView, @NonNull Button button4,
      ...
      @NonNull ImageView imageView35, @NonNull ConstraintLayout main, @NonNull TextView textView50,
  ...
  @NonNull
  public static FragmentGig2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentGig2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_gig2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentGig2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGig2Binding((ConstraintLayout) rootView, button4, button5, button6,
          button8, cardView18, imageView31, imageView34, imageView35, main, textView50, textView54,
