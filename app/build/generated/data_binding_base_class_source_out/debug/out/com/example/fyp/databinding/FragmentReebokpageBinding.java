...
public final class FragmentReebokpageBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentReebokpageBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView49, @NonNull ConstraintLayout main, @NonNull TextView textView37,
  ...
  @NonNull
  public static FragmentReebokpageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentReebokpageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_reebokpage, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentReebokpageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReebokpageBinding((ConstraintLayout) rootView, cardView12, cardView15,
          cardView16, imageView46, imageView47, imageView49, main, textView37, textView38,
