...
public final class FragmentNikepageBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentNikepageBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView12,
      @NonNull CardView cardView15, @NonNull CardView cardView16, @NonNull ImageView imageView15,
  ...
  @NonNull
  public static FragmentNikepageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentNikepageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_nikepage, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentNikepageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNikepageBinding((ConstraintLayout) rootView, cardView12, cardView15,
          cardView16, imageView15, imageView37, imageView38, main, textView37, textView38,
