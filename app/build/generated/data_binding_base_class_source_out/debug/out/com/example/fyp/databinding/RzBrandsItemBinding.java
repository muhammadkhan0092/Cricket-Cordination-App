...
public final class RzBrandsItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static RzBrandsItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RzBrandsItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rz_brands_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RzBrandsItemBinding bind(@NonNull View rootView) {
