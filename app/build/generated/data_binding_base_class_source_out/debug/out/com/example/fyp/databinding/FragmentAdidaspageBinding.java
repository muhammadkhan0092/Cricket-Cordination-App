...
public final class FragmentAdidaspageBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAdidaspageBinding(@NonNull ConstraintLayout rootView,
      @NonNull CardView cardView12, @NonNull CardView cardView15, @NonNull CardView cardView16,
      @NonNull ImageView imageView17, @NonNull ImageView imageView42,
      @NonNull ImageView imageView43, @NonNull ConstraintLayout main, @NonNull TextView textView37,
      @NonNull TextView textView38, @NonNull TextView textView39, @NonNull TextView textView42,
      ...
      @NonNull TextView textView49, @NonNull TextView textView51, @NonNull TextView textView52,
      @NonNull TextView textView53, @NonNull TextView textView55, @NonNull TextView textView56) {
  ...
  @NonNull
  public static FragmentAdidaspageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAdidaspageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_adidaspage, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAdidaspageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAdidaspageBinding((ConstraintLayout) rootView, cardView12, cardView15,
          cardView16, imageView17, imageView42, imageView43, main, textView37, textView38,
