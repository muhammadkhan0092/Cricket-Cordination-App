...
public final class FragmentGig7Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentGig7Binding(@NonNull ConstraintLayout rootView, @NonNull Button button4,
      @NonNull Button button5, @NonNull Button button6, @NonNull Button button8,
      @NonNull CardView cardView18, @NonNull ImageView imageView21, @NonNull ImageView imageView31,
      @NonNull ImageView imageView34, @NonNull ConstraintLayout main, @NonNull TextView textView50,
  ...
  @NonNull
  public static FragmentGig7Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentGig7Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_gig7, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentGig7Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGig7Binding((ConstraintLayout) rootView, button4, button5, button6,
          button8, cardView18, imageView21, imageView31, imageView34, main, textView50, textView54,
