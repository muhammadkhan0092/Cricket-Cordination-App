...
public final class FragmentFpageBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFpageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnBack,
      @NonNull Button btnLogin, @NonNull EditText editTextTextEmailAddress2,
      @NonNull Guideline guideline11, @NonNull Guideline guideline4, @NonNull Guideline guideline5,
      @NonNull Guideline guideline6, @NonNull Guideline guideline7, @NonNull Guideline guideline8,
      @NonNull ConstraintLayout main, @NonNull TextView textView5, @NonNull TextView textView9) {
  ...
  @NonNull
  public static FragmentFpageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFpageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_fpage, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFpageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFpageBinding((ConstraintLayout) rootView, btnBack, btnLogin,
          editTextTextEmailAddress2, guideline11, guideline4, guideline5, guideline6, guideline7,
          guideline8, main, textView5, textView9);
    }
