...
public final class FragmentGigBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentGigBinding(@NonNull ConstraintLayout rootView, @NonNull Button button4,
      @NonNull Button button5, @NonNull Button button6, @NonNull Button button8,
      @NonNull CardView cardView18, @NonNull ImageView imageView14, @NonNull ImageView imageView31,
  ...
  @NonNull
  public static FragmentGigBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentGigBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_gig, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentGigBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGigBinding((ConstraintLayout) rootView, button4, button5, button6, button8,
          cardView18, imageView14, imageView31, imageView34, main, textView50, textView54,
