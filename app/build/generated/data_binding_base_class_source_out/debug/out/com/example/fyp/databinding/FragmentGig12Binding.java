...
public final class FragmentGig12Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentGig12Binding(@NonNull ConstraintLayout rootView, @NonNull Button button4,
      ...
      @NonNull ImageView imageView51, @NonNull ConstraintLayout main, @NonNull TextView textView50,
  ...
  @NonNull
  public static FragmentGig12Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentGig12Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_gig12, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentGig12Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGig12Binding((ConstraintLayout) rootView, button4, button5, button6,
          button8, cardView18, imageView31, imageView34, imageView51, main, textView50, textView54,
