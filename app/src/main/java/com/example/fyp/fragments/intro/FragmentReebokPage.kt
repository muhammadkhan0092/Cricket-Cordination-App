...
import com.example.fyp.databinding.FragmentReebokpageBinding

class FragmentReebokPage : Fragment() {
    private lateinit var binding: FragmentReebokpageBinding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentReebokpageBinding.inflate(inflater, container, false)
        return binding.root
    }
