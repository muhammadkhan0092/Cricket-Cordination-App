...
import com.example.fyp.databinding.FragmentGig11Binding
import com.example.fyp.databinding.FragmentGig2Binding
import com.example.fyp.databinding.FragmentGig5Binding
import com.example.fyp.databinding.FragmentGig8Binding
...
class FragmentGigPage11 : Fragment() {
    private lateinit var binding : FragmentGig11Binding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentGig11Binding.inflate(inflater,container,false)
        return binding.root
    }
