...
import com.example.fyp.databinding.FragmentGig12Binding
...
import com.example.fyp.databinding.FragmentGig9Binding
...
class FragmentGigPage12 : Fragment() {
    private lateinit var binding : FragmentGig12Binding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentGig12Binding.inflate(inflater,container,false)
        return binding.root
    }
