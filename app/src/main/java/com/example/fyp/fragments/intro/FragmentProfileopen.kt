...
import com.example.fyp.databinding.OpenprofileBinding
...
class FragmentProfileopen : Fragment() {
    private lateinit var binding : OpenprofileBinding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = OpenprofileBinding.inflate(inflater,container,false)
        return binding.root
    }
